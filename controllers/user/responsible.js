    ...
    if (req.params !== null && req.params !== undefined && req.params.name && typeof req.params.name === 'string') {
        try {
            ...
            WHERE 
                A.id=$1 
                AND
                    (A.manager=$2 AND A.manager=B.id) 
                    OR A.manager=B.id
    ...
    if (req.params != null && req.params !== undefined
        ...
        try {
            ...
            if (dbresult.rows.length === 1) {
                ...
                let password = (req.user.id === req.params.name && req.body.password && typeof req.body.password === 'string' && req.body.password.length > 3) ? req.body.password : dbresult.rows[0].password;
                if (manager) {
