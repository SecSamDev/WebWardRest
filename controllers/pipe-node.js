const subControllerAdmin = require('./pipe-node/admin')
const subControllerResp = require('./pipe-node/responsible')
const subControllerProjMan = require('./pipe-node/projectManager')
const subControllerDev = require('./pipe-node/developer')
